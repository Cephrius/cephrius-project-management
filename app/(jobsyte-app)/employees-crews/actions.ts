...
// Onboarding: workforce mutations for the contractor app. UI entry points are
// `components/employees/employee-dialog.tsx`, `components/employees/crew-dialog.tsx`,
// and the employee web-app credential flow under `employee-app/app/api/auth/*`.
