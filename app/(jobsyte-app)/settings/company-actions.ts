...
// Onboarding: company create/switch/delete actions. These complement the client
// company picker in `components/app-shell/company-switcher.tsx` and the active
// company cookie logic in `lib/company-context.ts`.
